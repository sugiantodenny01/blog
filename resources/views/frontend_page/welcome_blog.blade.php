                                        ...
                                        <span class="post__date">
                                            ...
                                            <time class="published" datetime="2016-04-17 12:00:00">
                                               {{$first_post->created_at->diffForHumans()}}
                                                {{--diffForHumans()->salah satu method dari carbon--}}
                                            </time>
            ...
            <div class="col-lg-6">
                <article class="hentry post post-standard has-post-thumbnail sticky">
                        ...
                        <div class="post-thumb">
                            ...
                            <div class="overlay"></div>
                            <a href="{{$third_post->featured}}g" class="link-image js-zoom-image">
                                <i class="seoicon-zoom"></i>
                            </a>
                            <a href="#" class="link-post">
                                <i class="seoicon-link-bold"></i>
            ...
            <div class="container">
                ...
                <div class="offers">
                    ...
                    <div class="row">
                        <div class="case-item-wrap">
                            @foreach($programming->posts()->orderBy('created_at','desc')->take(3)->get() as $program)
                                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                    <div class="case-item">
                                        <div class="case-item__thumb">
                                            <img src="{{$program->featured}}" alt="our case">
                                        </div>
                                        {{--{{dd($programming->posts->first()->slug)}}--}}
                                        <h6 class="case-item__title"><a href="{{route('post.single',['slug'=>$programming->posts->first()->slug])}}">{{$program->title}}</a></h6>
                                    </div>
                                </div>
                            @endforeach
                ...
                <div class="offers">
                    <div class="row">
                        <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                            <div class="heading">
                                <h4 class="h1 heading-title">{{$framework->name}}</h4>
                                <div class="heading-line">
                                    <span class="short-line"></span>
                                    <span class="long-line"></span>
                                </div>
                    ...
                    <div class="row">
                        <div class="case-item-wrap">
                            ...
                            @foreach($framework->posts()->orderBy('created_at','desc')->take(3)->get() as $frameworks)
                                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                    <div class="case-item">
                                        <div class="case-item__thumb">
                                            <img src="{{$frameworks->featured}}" alt="our case">
                                        </div>
                                        {{--//{{route('post.single',['slug'=>$framework->posts->first()->slug])}}--}}
                                        {{--{{dd($framework->posts->first()->slug)}}--}}
                                        <h6 class="case-item__title"><a href="{{route('post.single',['slug'=>$framework->posts->first()->slug])}}">{{$frameworks->title}}</a></h6>
                                    </div>
                                </div>
...
<script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-5cda00032ee5d724"></script>
